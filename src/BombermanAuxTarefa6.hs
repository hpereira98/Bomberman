module BombermanAuxTarefa6 where
...
avanca [] x = []
avanca mapa x | verBomba mapa == False = cardinais mapa ++ listapowerups mapa ++ instanteBomba mapa ++ listajogadores2 mapa
             | verBomba mapa == True  = cardinais (arrebentaPI mapa (explodePI (tI mapa) (tB mapa) mapa)) ++ listapowerups (arrebentaPU mapa) ++ instanteBomba mapa ++ listajogadores2 (arrebentaBonecos mapa (explodeJ (tJ mapa) (tB mapa) mapa))
